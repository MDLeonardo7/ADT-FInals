  ...
  const handleSearch = useCallback(() => {
    ...
    axios.get(`https://api.themoviedb.org/3/search/movie?query=${query}&include_adult=false&language=en-US&page=${currentPage}`, {
      headers: {
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjNzcxZjY1MGM2ZjU0ZjU1ZmE2ZTcwNTlkZDE2YTE0MyIsIm5iZiI6MTczMzM4Mjg2NC4yOTIsInN1YiI6IjY3NTE1MmQwMzQ5NGNjOWJmYmM1Zjc1MyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.SSAMXml0D5Cg0M0moYigw4A0Hc_ahe2fQqUwEboLOfE',
      },
    })
      .then((response) => {
  ...
  const handleSelectMovie = (movie) => {
    ...
    setError("");
      ...
      .get(`https://api.themoviedb.org/3/movie/${movie.id}/images`, {
        headers: {
          Accept: "application/json",
          Authorization: 'Bearer JhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjNzcxZjY1MGM2ZjU0ZjU1ZmE2ZTcwNTlkZDE2YTE0MyIsIm5iZiI6MTczMzM4Mjg2NC4yOTIsInN1YiI6IjY3NTE1MmQwMzQ5NGNjOWJmYmM1Zjc1MyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.SSAMXml0D5Cg0M0moYigw4A0Hc_ahe2fQqUwEboLOfE',
        },
      })
      .then((response) => {
      ...
      axios.get(`/movies/${movieId}`)
        .then((response) => {
          ...
          return axios.get(`https://api.themoviedb.org/3/movie/${movieData.tmdbId}/videos?language=en-US`, {
            headers: {
              Accept: "application/json",
              Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjNzcxZjY1MGM2ZjU0ZjU1ZmE2ZTcwNTlkZDE2YTE0MyIsIm5iZiI6MTczMzM4Mjg2NC4yOTIsInN1YiI6IjY3NTE1MmQwMzQ5NGNjOWJmYmM1Zjc1MyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.SSAMXml0D5Cg0M0moYigw4A0Hc_ahe2fQqUwEboLOfE', // Replace with actual API key
            },
          });
        })
        .then(response => {
